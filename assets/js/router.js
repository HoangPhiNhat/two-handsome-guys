  ...
  async handleRoute() {
    ...
    try {
      ...
      if (
        ...
        const defaultSectionId = moduleData.sections[0].id;
        window.location.hash = `#${moduleId}/${defaultSectionId}`;
        return;
      }
      ...
      if (sectionId) {
        await Renderer.renderSectionView(moduleData, sectionId);
      } else {
      ...
      Renderer.renderError(
        `Cannot load module '${moduleId}': ${error.message}`,
      );
    }
  },
